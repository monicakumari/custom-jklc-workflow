...
(function()
{
   ...
   YAHOO.lang.augmentObject(Alfresco.component.TaskList.prototype,
   {
     		  ...
     		  successCallback : {
     		    fn : function (res) {
     		      ...
     		      if(result.children.length>0){
     		    	  ...
     		    	  this.callFunction(elCell, oRecord, oColumn, oData,docNodeRef);
     		      }else{
     		    	  this.callFunction(elCell, oRecord, oColumn, oData,"");
     		      }
     		    },
     		    scope : this
     		  },
      ...
      callFunction:function callFunction(elCell, oRecord, oColumn, oData,docNodeRef)
	  {
		    ...
		    if(oRecord.getData('isEditable'))
		    {
		       ...
		       if(docNodeRef){
		    	   href = $siteURL('task-edit?taskId=' + taskId + '&nodeRef='+docNodeRef) + '" class="theme-color-1" title="' + this.msg("link.editTask");
		       }
		    }
		    else
		    {
           	 ...
           	 Alfresco.util.Ajax.jsonGet({
           		  ...
           		  successCallback : {
           		    fn : function (res) {
           		      ...
           		      if(result.children.length>0){
           		    	  var docNodeRef=result.children[0].nodeRef;
           		    	 this.createAction(elCell, this.msg("link.editTask"), "task-edit-link", $siteURL('task-edit?taskId=' + oRecord.getData('id') + '&nodeRef='+docNodeRef));
           		      }else{
