...
(function()
{
    ...
    * @constructor
    */
   Alfresco.ObjectFinderCustom = function Alfresco_ObjectFinderCustom(htmlId, currentValueHtmlId)
   {
      Alfresco.ObjectFinderCustom.superclass.constructor.call(this, "Alfresco.ObjectFinderCustom", htmlId, ["button", "menu", "container", "resize", "datasource", "datatable"]);
   ...
   YAHOO.extend(Alfresco.ObjectFinderCustom, Alfresco.component.Base,
   {
      /**
      ...
      {
         Alfresco.ObjectFinderCustom.superclass.setOptions.call(this, obj);
      ...
      {
         Alfresco.ObjectFinderCustom.superclass.setMessages.call(this, obj);
      ...
      destroy: function ObjectFinder_destroy()
      {
         ...
         Alfresco.ObjectFinderCustom.superclass.destroy.call(this);
      },
                  ...
                  if (items.hasOwnProperty(key))
                  {
                     ...
                     else
                     {
                        if (this.options.displayMode == "items")
                        {
                           ...
                           {
                        	   var cnt= "No."+user_label;
                              displayValue += this.options.objectRenderer.renderItem(item, 16, "<div class='itemtype-" + $html(item.type) + "' style='word-wrap: break-word;'> "+cnt+"{icon} {name}</div>");
                              user_label++;
                           }
                        }
                        else if (this.options.displayMode == "list")
